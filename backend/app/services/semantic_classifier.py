...
ENRICHED_COLUMN_MAPPING = {
    "account_code": {
        "keywords": ["compte", "code", "n°", "N°", "numero", "num", "n", "account", "acc"],
    ...
    "label": {
        "keywords": ["intitulé", "libellé", "Libellé écriture", "description", "nom", "name", "label", "designation"],
    ...
    "solde_debit": {
        "keywords": ["solde débiteur", "solde deb", "solde debit", "balance debit"],
        "description": "balance debit total debit accounting account balance debit side",
        "expected_content": {"type": "numeric", "avg_length": 12, "numeric_ratio": 0.8, "decimal_ratio": 0.6},
    },
    "solde_credit": {
        "keywords": ["solde créditeur", "solde cdt", "solde credit", "balance credit"],
        "description": "balance credit total credit accounting account balance credit side",
        "expected_content": {"type": "numeric", "avg_length": 12, "numeric_ratio": 0.8, "decimal_ratio": 0.6},
    },
    "solde_final": {
        "keywords": ["solde", "solde final", "value", "montant", "total", "final", "amount", "balance"],
        "description": "final balance total amount final value accounting balance total",
